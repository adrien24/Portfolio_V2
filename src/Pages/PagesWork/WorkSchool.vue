        ...
        <li ref="li" v-on:click="show()">
          <div class="myProject">
            <div class="presentation">
              <span>DOUBLEBOGGEY</span>
              <span>This project was created in 2021 / 2022</span>
            </div>
            <div id="show" class="remove none">
              <div class="description">
                <p>Double Boggey is an association of golfers from Occitania. This association aims to bring together
                  many people to share friendly moments around the world of golf. Their image on the net is however not
                  very representative of their association and they want to improve it.</p>
              </div>
              <div class="link">
                <a href="https://doubleboggey.fr/" class="cool-link">Voir le site</a>
              </div>
            </div>
          </div>
        </li>
        <li ref="li" v-on:click="show1()">
          <div class="myProject">
            ...
            <div id="show1" class="remove none">
              <div class="description">
                <p>
                  The boss is a test that we do at the end of the third semester, it consists of creating a website in 2
                  days on a subject chosen by our teachers. The first day we have to make a model and then integrate it
                  into HTML5/CSS/JS. Then the second day we have to integrate it into Vue.js. The theme of this year's
                  boss was to create a site about a film director, drawing inspiration from his cinematographic
                  universe.</p>
              </div>
              <div class="link">
                <a href="https://adrienbouteiller.com/Michelangelo/#/" class="cool-link">Voir le site</a>
              </div>
            </div>
          </div>
        </li>
        <li ref="li" v-on:click="show2()">
          <div class="myProject">
            ...
            <div id="show2" class="remove none">
              <div class="description">
                <p>The Nearide project consisted of creating a platform on which would be referenced urban sports spots
                  such as skateboarding, rollerblading, BMX and others in Bourgogne Franche Comté. Indeed, having
                  practiced these sports a lot for a time. We wanted to create a platform different from the others by
                  focusing on the region in order to reference as many spots as possible, given that other platforms of
                  this type do not have this precision. In addition, we want, in addition to referring to skateparks, to
                  refer to natural spots called "street".</p>
              </div>
              <div class="link">
                <a href="https://adrienbouteiller.com/Nearide/Nearide_page/index.php" class="cool-link">Voir le site</a>
              </div>
            </div>
          </div>
        </li>
